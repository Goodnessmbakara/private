...
from chat_app.models import MessageModel, UploadedFile
from chat_app.serializers import serialize_file_model
from django.conf import settings
import logging

logger = logging.getLogger('chat_app.chat_consumer')
